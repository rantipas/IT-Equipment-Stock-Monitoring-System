...
where FullName like '/Consumables/%' ";
...
$sql1 = "select m.Name As Device_Name,p.fqty As Qty from amModel m join amPortfolio p on m.lModelId = p.lModelId join amStock s on p.lStockId = s.lStockId join amNature n on m.lNatureId = n.lNatureId
where s.[Name]='mtcbu' and m.lParentId='$lModelId'
group by m.Name, p.fqty";
